...
data class DBTrip(@PrimaryKey(autoGenerate = true) var idTrip: Int = 0) : BaseModel {
    ...
    @Ignore
    val subTrips: MutableList<DBTrip> = mutableListOf()
     ...
     * @return
     */
    private fun compatibleActivityType(otherTrip: DBTrip): Boolean {
    ...
    private fun getTripSteps(): MutableList<DBStep> {
        val steps: MutableList<DBStep> = mutableListOf()
     ...
     * @return
     */
    private fun getTripLocations(): MutableList<DBLocation> {
        var locations: MutableList<DBLocation> = mutableListOf()
     ...
     * @return the distance
     */
    fun getTripRadius(baseLocation: DBLocation?): Int {
     ...
     * @return
     */
    fun trimTripDuration(newActivityType: Int): List<DBTrip> {
        val finalList = mutableListOf<DBTrip>()
    ...
    fun findWalkingMovementInStepsList(steps: MutableList<DBStep>, activityType: Int, chart: MutableList<MobilityData>): MutableList<DBTrip> {
        val tripsList = mutableListOf<DBTrip>()

        var prevSteps: DBStep? = null
     ...
     */
    private fun getChartIndexOfSteps(step: DBStep, chart: MutableList<MobilityData>): Int {
